...
from cs336_basics.tokenize import Tokenizer, from_files
from cs336_basics.tokenizer import run_tokenizer
    ...
    Returns:
        tuple[dict[int, bytes], list[tuple[bytes, bytes]]]:
            ...
            merges:
                ...
                Merges are ordered by order of creation.
    """
    return run_tokenizer(input_path, vocab_size, special_tokens)
